...
import {cardPerfilInfoStyles} from "../stylesComponents/cardPerfilInfo";
export default function CardPerfilInfo(){
    ...
    return(
        <View style={cardPerfilInfoStyles.cardInfo}>
          ...
          <TouchableOpacity style={cardPerfilInfoStyles.editButton}
          ...
          <View style={cardPerfilInfoStyles.textInfo}>
            <TextInput style={cardPerfilInfoStyles.inputInfo} editable={isEditing} placeholder="José" />
          </View>

          <Text style={cardPerfilInfoStyles.labelInfo}>Email:</Text>
          <View style={cardPerfilInfoStyles.textInfo}>
            <TextInput style={cardPerfilInfoStyles.inputInfo} editable={isEditing} placeholder="Jose@gmail.com" />
          </View>

          <Text style={cardPerfilInfoStyles.labelInfo}>Telefone:</Text>
          <View style={cardPerfilInfoStyles.textInfo}>
            <TextInput style={cardPerfilInfoStyles.inputInfo} editable={isEditing} placeholder="(85) 9 9999-9999" />
          </View>

          <Text style={cardPerfilInfoStyles.labelInfo}>Data de Nascimento:</Text>
          <View style={cardPerfilInfoStyles.textInfo}>
            <TextInput style={cardPerfilInfoStyles.inputInfo} editable={isEditing} placeholder="01/01/2001" />
          </View>

          <Text style={cardPerfilInfoStyles.labelInfo}>Endereço:</Text>
          <View style={cardPerfilInfoStyles.textInfo}>
            <TextInput style={cardPerfilInfoStyles.inputInfo} editable={isEditing} placeholder="Rua A 10" />
          </View>
          </View>
    );
}