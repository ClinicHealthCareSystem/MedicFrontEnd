...
import {cardDashboardStyles} from "../stylesComponents/cardasboard";
      ...
      <View style={cardDashboardStyles.infoContainer}>
        ...
        <View style={cardDashboardStyles.column}>
          ...
          <View style={cardDashboardStyles.infoRow}>
            ...
            <Text style={cardDashboardStyles.textLabel}>
              Alergia:{" "} <Text style={cardDashboardStyles.textValue}>Dipirona</Text>
            </Text>
          </View>
        </View>
        ...
        <View style={cardDashboardStyles.column}>
          ...
          <View style={cardDashboardStyles.infoRow}>
            ...
            <Text style={cardDashboardStyles.textLabel}>
              Tipo Sanguíneo:{" "} <Text style={cardDashboardStyles.textValue}>O+</Text>
            </Text>
          </View>
        </View>
      </View>
